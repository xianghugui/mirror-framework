...
public class JiguangPush {
    ...
    private static String masterSecret = "81acbf5e3db01e86296f663b";
    private static String appKey = "70b8bd56743a5da207b54364";
    private static final String ALERT = "推送信息";
    /**
     * 极光推送
     */
    public void jiguangPush(){
        String alias = "wangwei";//声明别名
...
//                                .build())
    ...
    public static PushResult push(String alias,String alert){
        ...
        try {
            System.out.println("推送消息：" + payload.toString());
