...
public class MybatisProperties extends org.mybatis.spring.boot.autoconfigure.MybatisProperties {
     ...
     * 默认支持的base mapper
     */
    private static final String   defaultMapperLocation  = "classpath*:com/base/web/dao/impl/mybatis/mapper/**/*.xml";
    /**
     * 是否启用动态数据源
     * 启用后调用{@link com.base.web.core.datasource.DynamicDataSource#use(String)},mybatis也会进行数据源切换
     *
     * @see com.base.web.core.datasource.DynamicDataSource
     */
